...
public class TaskSuccess implements JadescriptPredicate {
  ...
  public String toString() {
    ...
    _sb.append("FIPArequest.onto.TaskSuccess");
    _sb.append("(");
  ...
  public boolean equals(final Object obj) {
    if(obj instanceof TaskSuccess) {
    	TaskSuccess o = (TaskSuccess) obj;
  ...
  public TaskSuccess(final Integer id_of_request) {
    super();
  ...
  private FIPArequest.onto.OntologyRequest __metadata_FIPArequest_onto_TaskSuccess(final Integer id_of_request) {
    return null;
  }
}
