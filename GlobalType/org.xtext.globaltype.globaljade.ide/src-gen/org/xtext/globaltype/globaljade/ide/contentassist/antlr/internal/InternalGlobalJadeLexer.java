...
public class InternalGlobalJadeLexer extends Lexer {
    ...
    public final void mRULE_TYPE_MESSAGE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGlobalJade.g:1210:19: ( ( 'CFP' | 'REJECT-PROPOSAL' | 'ACCEPT-PROPOSAL' ) )
            // InternalGlobalJade.g:1210:21: ( 'CFP' | 'REJECT-PROPOSAL' | 'ACCEPT-PROPOSAL' )
            {
            // InternalGlobalJade.g:1210:21: ( 'CFP' | 'REJECT-PROPOSAL' | 'ACCEPT-PROPOSAL' )
            int alt1=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt1) {
                case 1 :
                    // InternalGlobalJade.g:1210:22: 'CFP'
                    {
                    match("CFP"); 
                    ...
                    break;
                case 2 :
                    // InternalGlobalJade.g:1210:28: 'REJECT-PROPOSAL'
                    {
                    ...
                    break;
                case 3 :
                    // InternalGlobalJade.g:1210:46: 'ACCEPT-PROPOSAL'
                    {
    ...
    public final void mRULE_GENERAL_NAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGlobalJade.g:1212:19: ( ( 'A' .. 'Z' )+ ( 'a' .. 'z' )* )
            // InternalGlobalJade.g:1212:21: ( 'A' .. 'Z' )+ ( 'a' .. 'z' )*
            {
            // InternalGlobalJade.g:1212:21: ( 'A' .. 'Z' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalGlobalJade.g:1212:22: 'A' .. 'Z'
            	    {
            	    matchRange('A','Z'); 
            ...
            // InternalGlobalJade.g:1212:33: ( 'a' .. 'z' )*
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalGlobalJade.g:1212:34: 'a' .. 'z'
            	    {
            	    matchRange('a','z'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGlobalJade.g:1214:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalGlobalJade.g:1214:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalGlobalJade.g:1214:11: ( '^' )?
            int alt4=2;
            ...
            // InternalGlobalJade.g:1214:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGlobalJade.g:1216:10: ( ( '0' .. '9' )+ )
            // InternalGlobalJade.g:1216:12: ( '0' .. '9' )+
            {
            // InternalGlobalJade.g:1216:12: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
            do {
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalGlobalJade.g:1216:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGlobalJade.g:1218:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalGlobalJade.g:1218:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalGlobalJade.g:1218:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalGlobalJade.g:1218:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalGlobalJade.g:1218:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                    ...
                    break;
                case 2 :
                    // InternalGlobalJade.g:1218:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalGlobalJade.g:1218:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGlobalJade.g:1220:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalGlobalJade.g:1220:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalGlobalJade.g:1220:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGlobalJade.g:1222:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalGlobalJade.g:1222:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalGlobalJade.g:1222:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
            ...
            // InternalGlobalJade.g:1222:40: ( ( '\\r' )? '\\n' )?
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalGlobalJade.g:1222:41: ( '\\r' )? '\\n'
                    {
                    // InternalGlobalJade.g:1222:41: ( '\\r' )?
                    int alt12=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGlobalJade.g:1224:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalGlobalJade.g:1224:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalGlobalJade.g:1224:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGlobalJade.g:1226:16: ( . )
            // InternalGlobalJade.g:1226:18: .
            {
            matchAny(); 
    ...
    static final String[] DFA15_transitionS = {
            "\11\31\2\30\2\31\1\30\22\31\1\30\1\31\1\25\4\31\1\26\1\3\1\4\2\31\1\7\2\31\1\27\12\24\1\31\1\14\5\31\1\20\1\21\1\16\16\21\1\17\10\21\3\31\1\22\1\23\1\31\3\23\1\12\1\23\1\10\1\1\1\23\1\11\6\23\1\2\1\23\1\15\1\23\1\13\6\23\1\5\1\31\1\6\uff82\31",
            "\1\32",
            "\1\34",
            "",
            "",
