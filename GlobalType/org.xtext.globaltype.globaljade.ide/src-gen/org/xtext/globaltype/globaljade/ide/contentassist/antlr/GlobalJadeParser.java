...
public class GlobalJadeParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GlobalJadeGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getChoiceAccess().getMessagesAssignment_4(), "rule__Choice__MessagesAssignment_4");
			builder.put(grammarAccess.getChoiceAccess().getBranchAssignment_5(), "rule__Choice__BranchAssignment_5");
			builder.put(grammarAccess.getChoiceAccess().getMessagesAssignment_7_2(), "rule__Choice__MessagesAssignment_7_2");
